...
# available_coins = [50, 10, 5, 2, 1]
# user_price = int(input("Введите стоимость товара: "))
#
# for coin in available_coins:
#     if user_price:
#         print(f"Внесите монеты номиналом {coin}: {user_price // coin}")
#         user_price %= coin
...
# print(f"Измененный список:  {squared_numbers}")